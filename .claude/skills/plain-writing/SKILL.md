---
name: plain-writing
description: "Write and edit prose in the user's plain style: simple everyday words, complete sentences, no dashes, no jargon, no analogies, no filler, full clear explanations. Use whenever drafting or revising prose for the user (documents, reports, summaries, emails, commit and PR descriptions) or when asked to simplify or clean up writing. Default for prose unless another style is requested; not for code."
---

...
def main():
    ...
    parser.add_argument(
        "--aspect-ratio", "-a",
        default=None,
        help="Optional aspect ratio, e.g. 1:1, 3:2, 16:9, 21:9 (passed to ImageConfig)"
    )
